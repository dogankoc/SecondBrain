...
export SECOND_BRAIN_GEMINI_FAST="${SECOND_BRAIN_GEMINI_FAST:-gemini-3.5-flash-lite}"
export SECOND_BRAIN_GEMINI_SMART="${SECOND_BRAIN_GEMINI_SMART:-gemini-3.6-flash}"
