...
d.update({'product':'Second Brain','user_name':name,'language':lang,'checkpoint_minutes':minutes})
...
START='<!-- SECOND-BRAIN:START -->';END='<!-- SECOND-BRAIN:END -->'
body=(f"{START}\n# Second Brain — Global Memory\n\nCentral memory vault: `{v}`\n\n"
